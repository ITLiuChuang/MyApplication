...
public class SystemVideoPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        btuExit = (Button) findViewById(R.id.btn_exit);
        btuPre = (Button) findViewById(R.id.btn_pre);
        btuStartPause = (Button) findViewById(R.id.btn_start_pause);
        btuNext = (Button) findViewById(R.id.btn_next);
        btuSwichScreen = (Button) findViewById(R.id.btn_swich_screen);
    ...
    private void startVitamioVideoPlayer() {
        ...
        if (mediaItems != null && mediaItems.size() > 0) {
            ...
            //列表数据
            bundel.putSerializable("videolist", mediaItems);
